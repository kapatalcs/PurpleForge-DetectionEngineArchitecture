...
handler = logging.FileHandler("labs/insecure_file_upload_with_extension/logs/access.log")
...
def upload(): 
    ...
    if request.method == "POST": 
        ...
        log_entry = {
            ...
            "ip": ip,
            "lab": "insecure_file_upload_with_extension",
            "resource": "/upload",
            "action": action,
            "metadata": {
                "mime_category": mime_category,
                "extension": os.path.splitext(file.filename)[1][1:],
                "extension_count": file.filename.count(".")
    }
}
